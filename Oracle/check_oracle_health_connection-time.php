...
$opt[1] = '--vertical-label seconds --title "' . $hostname . ' / Connection Time"';
$opt[1] .= ' --watermark="Template: check_oracle_health_connection-time by Yannick Charton"';
$ds_name[1] = 'Oracle connection time';
$def[1] = "";
...
$def[1] .= "AREA:var1" . $_AREA . ":\"Connection time\" ";
