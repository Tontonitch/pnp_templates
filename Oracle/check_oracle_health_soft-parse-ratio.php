...
$opt[1] = '--vertical-label "ratio (%)" --title "' . $hostname .' / Soft parse ratio" --upper-limit=100 --lower-limit=0';
$opt[1] .= ' --watermark="Template: check_oracle_health_soft-parse-ratio by Yannick Charton"';
$ds_name[1] = $LABEL[1];
