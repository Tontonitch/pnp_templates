...
$opt[1] = '--vertical-label "ratio (%)" --title "' . $hostname .' / SGA dictionnary cache hit ratio" --upper-limit=100 --lower-limit=0 --rigid';
$opt[1] .= ' --watermark="Template: check_oracle_health_sga-dictionnary-cache-hit-ratio by Yannick Charton"';
$ds_name[1] = $LABEL[1];
