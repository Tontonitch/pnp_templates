...
$opt[1] = '--vertical-label "%" --title "' . $hostname .' / SGA shared pool free" --upper-limit=100 --lower-limit=0 --rigid';
$opt[1] .= ' --watermark="Template: check_oracle_health_sga-shared-pool-free by Yannick Charton"';
$ds_name[1] = $LABEL[1];
$def[1]  = rrd::def     ("var1", $RRDFILE[1], $DS[1], "AVERAGE");
#$def[1] .= rrd::area    ("var1", $_AREA, "Hit ratio", 20);
$def[1] .= rrd::gradient("var1", "#90EE90", "#8FBC8F", "Free memory", 20);
