...
foreach ($this->DS as $KEY=>$VAL) {
        ...
        $def[$KEY] .= "GPRINT:var1:LAST:\"Last\: %3.4lf ".$VAL['UNIT']."\" ";
        $def[$KEY] .= "GPRINT:var1:MAX:\"Max\: %3.4lf ".$VAL['UNIT']."\" ";
        $def[$KEY] .= "GPRINT:var1:MIN:\"Min\: %3.4lf ".$VAL['UNIT']."\\n\" ";
        if ($warning != "") {
        ...
        $def[$KEY] .= 'COMMENT:"CheckFileSize\r" ';
